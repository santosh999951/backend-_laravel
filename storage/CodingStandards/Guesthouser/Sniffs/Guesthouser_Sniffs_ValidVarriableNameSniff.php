 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Guesthouser_Sniffs_ValidVarriableNameSniff extends AbstractVariableSniff
{
    ...
    protected function processVariable(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($stackPtr - 1)]['code'] === T_PAAMAYIM_NEKUDOTAYIM) {
            ...
            if (preg_match(self::$camelcase, $varName)) {
                ...
                $phpcsFile->addError($error, $stackPtr, 'NotUnderscore', [$varName]);
            }
        ...
        if ($tokens[$objOperator]['code'] === T_OBJECT_OPERATOR) {
            ...
            if ($tokens[$var]['code'] === T_STRING) {
                $bracket = $objOperator = $phpcsFile->findNext([T_WHITESPACE], ($var + 1), null, true);
    ...
    protected function processMemberVar(File $phpcsFile, $stackPtr)
    {
        ...
        if (($memberProps['is_static'] && preg_match(self::$camelcase, $varName))
