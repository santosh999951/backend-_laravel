...
class PostRegisterTest extends TestCase
{
     ...
     * @return void
     */
    public function testResponseSourceEmail()
    {
        ...
        $param = [
            'source_value' => 'testing.new.api'.strtolower(str_random(4)).'@guesthouser.com',
            'password'     => base64_encode(111111),
            'first_name'   => 'Unit Testing',
            'last_name'    => 'Api',
            'source'       => EMAIL_SOURCE_ID,
        ];
        ...
        Event::assertDispatched(
            ...
            function ($event) use ($param) {
                return (
                $event->user->email === $param['source_value'] &&
                $event->source === EMAIL_SOURCE_ID
                );
            }
        );

    }//end testResponseSourceEmail()
     ...
     * @return void
     //
     */
    public function testResponseSourcePhone()
    {
        // Check event is fired.
        Event::fake();
        ...
        $source_value = rand(1111111111, 9999999999);

        // Create Demo Entry in otp_contact table.
        $sms_otp = $this->createSmsOtp(['contact' => '91'.$source_value]);
        ...
        $param = [
            ...
            'first_name'   => 'Unit Testing',
            'last_name'    => 'Api',
            'source'       => PHONE_SOURCE_ID,
            'otp_code'     => $sms_otp[0]['verification_code'],
        ];
        ...
        Event::assertDispatched(
            ...
            function ($event) use ($param) {
                ...
                $event->source === PHONE_SOURCE_ID
                );
            }
        );

    }//end testResponseSourcePhone()


    /**
     * Source Phone without email
     *
     * @return void
     */
    public function testResponseSourcePhoneWithoutEmail()
    {
        $location = $this->getLocation();
    ...
    }//end testResponseSourcePhoneWithoutEmail()
