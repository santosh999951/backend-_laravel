<?php
/**
 * Add Property Request model containing Request Model Validation related Method.
 */
 ...
 * Class PostProperty
 */
class PostProperty extends BaseFormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'accomodation'           => 'required|integer|min:1',
            'per_unit_extra_guests'  => 'required|integer|min:0',
            'bedrooms'               => 'required|integer|min:1',
            'beds'                   => 'required|integer|min:1',
            'bathrooms'              => 'required|integer|min:1',
            'title'                  => 'required|string|min:3|max:100',
            'currency'               => 'required|string|min:3|max:3',
            'per_night_price'        => 'required|numeric|min:1',
            'gh_commission'          => 'required|numeric|min:1',
            'noc_status'             => 'required|integer|in:0,1',
            ...
            'cancelation_policy'     => 'required|integer|min:1',
