<?php
/**
 * Properly Expense accordance Index Request model containing Request Model Validation related Method.
 */
...
/**
 * Class GetProperlyExpenseAccordanceRequest
 */
class GetProperlyExpenseAccordanceRequest extends BaseFormRequest
{
