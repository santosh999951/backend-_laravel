...
return [
    ...
    'paths'                 => [
        ...
        */
        ...
        /*
            |--------------------------------------------------------------------------------------------------------
            | File basename(without extension) under api_doc directory that you would like to exclude from swagger ui
            |--------------------------------------------------------------------------------------------------------
        */
    ...
    */
    ...
    'constants'             => [
        'API_HOST'        => env('SWAGGER_API_HOST', 'api.services.local:8000/v1.6'),
        'API_VERSION'     => env('SWAGGER_API_VERSION', '1.6.0'),
        'DEVELOPER_EMAIL' => env('DEVELOPER_EMAIL', 'vikas.b@guesthouser.com'),
        'CLIENT_ID'       => 2,
        'CLIENT_SECRET'   => 'egOc9ewzDzpuLJqGJhHTQKB3XdRnCEBE9YcZgYlH',
    ],
