<?php
/**
 * Response Model For User Wishlist API
 */

namespace App\Http\Response\v1_6\Models;

/**
 * Class GetUserWishlistResponse
 *
 * // phpcs:disable
 * @SWG\Definition(
 * definition="GetUserWishlistResponse",
 * description="Response Model For User Wishlist API",
 * )
 * // phpcs:enable
 */
class GetUserWishlistResponse extends ApiResponse
{

    /**
     * User Wishlist Property List
     *
     * @var array
	 * // phpcs:disable
	 * @SWG\Property(
	 ...
	 *   type="array",
	 *   default="[]",
	 *   description="User Wishlist Property List",
	 *   @SWG\Items(
	 *     type="object",
	 *     @SWG\Property(
	 ...
	 *       type="integer",
	 *       default="0",
	 *       description="Property Is Wishlisted By User Status"
	 *     ),
	 *     @SWG\Property(
	 *       property="prices",
	 *       type="object",
	 ...
	 *           type="string",
	 *           default="",
	 *           description="Tag Color Code in Rgb Format Eg. (212, 134, 133)"
	 *         ),
	 *         @SWG\Property(
	 *           property="colorHex",
	 *           type="string",
