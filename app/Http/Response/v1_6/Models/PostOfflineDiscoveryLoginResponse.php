<?php
/**
 * PostOfflineDiscoveryLoginResponse
 */

namespace App\Http\Response\v1_6\Models;

/**
 * Class PostOfflineDiscoveryLoginResponse
 *
 * // phpcs:disable
 * @SWG\Definition(
 * definition="PostOfflineDiscoveryLoginResponse",
 * description="PostOfflineDiscoveryLoginResponse",
 * )
 * // phpcs:enable
 */
class PostOfflineDiscoveryLoginResponse extends ApiResponse
{
	 ...
	 *       type="integer",
	 *       default="0",
	 *       description="User Is Mobile Verified"
	 *     ),
	 *     @SWG\Property(
	 ...
	 *       type="integer",
	 *       default="0",
	 *       description="User Is Avatar Image"
	 *     ),
	 *     @SWG\Property(
