<?php
/**
 * Response Model for Login Old api User
 */

namespace App\Http\Response\v1_6\Models;

/**
 * Class PostUserLoginoldappuserResponse
 *
 * // phpcs:disable
 * @SWG\Definition(
 * definition="PostUserLoginoldappuserResponse",
 * description="Response Model for Login Old api User",
 * )
 * // phpcs:enable
 */
class PostUserLoginoldappuserResponse extends ApiResponse
{
	 ...
	 *       type="string",
	 *       default="",
	 *       description="User Membership time in Guesthosuer"
	 *     ),
	 *     @SWG\Property(
	 *       property="dob",
	 *       type="string",
	 ...
	 *       type="integer",
	 *       default="0",
	 *       description="User Avatar Image Status"
	 *     ),
	 *     @SWG\Property(
	 ...
	 *       type="boolean",
	 *       default="false",
	 *       description="User Is Host Status for Host section"
	 *     ),
	 *     @SWG\Property(
	 *       property="user_id",
	 *       type="integer",
	 ...
	 *       type="integer",
	 *       default="0",
	 *       description="User Add Email Status when email not exist"
	 *     ),
	 *     @SWG\Property(
	 *       property="host_token",
	 *       type="string",
