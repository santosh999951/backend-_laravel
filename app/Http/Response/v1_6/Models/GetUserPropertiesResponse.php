<?php
/**
 * Response Model for User Listed Properties Api
 */
 ...
 * // phpcs:disable
 * @SWG\Definition(
 * definition="GetUserPropertiesResponse",
 * description="Response Model for User Listed Properties Api",
 * )
 * // phpcs:enable
 */
class GetUserPropertiesResponse extends ApiResponse
{

    /**
     * Properties Listed By user list
     *
     * @var array
	 * // phpcs:disable
	 * @SWG\Property(
	 ...
	 *   type="array",
	 *   default="[]",
	 *   description="Properties Listed By user list",
	 *   @SWG\Items(
	 *     type="object",
	 *     @SWG\Property(
	 ...
	 *           type="string",
	 *           default="",
	 *           description="Tag Color Code in Rgb Format Eg. (212, 133, 134)"
	 *         ),
	 *         @SWG\Property(
	 *           property="colorHex",
	 *           type="string",
