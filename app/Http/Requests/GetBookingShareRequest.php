<?php
/**
 * Fb Booking share Request model containing Request Model Validation related Method.
 */
...
/**
 * Class GetBookingShareRequest
 */
class GetBookingShareRequest extends BaseFormRequest
{
