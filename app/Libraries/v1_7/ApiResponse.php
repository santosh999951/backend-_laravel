...
class ApiResponse
{
     ...
     * @param string  $message Message in Response.
     *
     * @return \Illuminate\Http\JsonResponse
     */
    public static function success(array $data, int $status=OK_HTTP_STATUS_CODE, string $message='')
    {
        $content = [
            'status'  => true,
            'data'    => $data,
     ...
     */
    public static function create(array $data, string $message)
    {
        return self::success($data, CREATED_HTTP_STATUS_CODE, $message);
