...
<table border="0" cellpadding="0" cellspacing="0" style="background:#fff; margin:0 auto; " width="600">
    <tbody>
        ...
        <tr>
            ...
            <h1 style=" font-size:35px; margin-top:20px; line-height:50px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color:#00a99d; margin-bottom:0; font-weight:500; text-align:center;">Our explorer has had a change of plans!</h1>
            &nbsp;
            </td>
        </tr>
        <tr>
            ...
            We regret to inform you that {{ $view_data['traveller_name'] }}, who booked the following property for {{ $view_data['check_in'] }} to {{ $view_data['check_out'] }}, has had a change of mind and cancelled the following booking: <br><br>
            Property: <a href="{{ $view_data['property_url'] }}" style="color:#14ace7; text-decoration:none;">{{ $view_data['property_title'] }}</a></h2>
            </td>
        </tr>
        ...
        <tr>
            <td class="textContent" style="padding-top:40px; padding-left:40px; padding-right:40px; text-align:center;" valign="top">
                <a href="{{ $view_data['request_url'] }}" style="text-decoration:none; display:inline-block; color:#fff; font-size:0.9em; padding:8px 20px; background:#7bc697; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;"> Click to View Details</a> 
            </td>
        </tr>
