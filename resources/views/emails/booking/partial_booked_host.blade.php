...
<html
    ...
    <body>
        <center style="width:100%;  background:#7ac697; padding:30px 0 30px 0; min-width:600px;">
            ...
            We have some good news!. We are happy to inform you that we have received the remaining amount from the guest against Booking ID: {{ $view_data['request_hash_id'] }}. Now, you don't need to collect any amount from the guest.

            {{ $view_data['traveller_name'] }} for accommodation in the following property for the period {{ $view_data['check_in'] }} to {{ $view_data['check_out'] }}:
                                <br>
                                    <br>Property: 
