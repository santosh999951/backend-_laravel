...
<table border="0" cellpadding="0" cellspacing="0" style="background:#fff; margin:0 auto; " width="600">
    <tbody>
        ...
        <tr>
            <td class="textContent" style="padding-top:0px; text-align:center; padding-left:0px; padding-right:0;" valign="top"><img src="{{ $view_data['new_request_image'] }}" style="display: inline-block;" /></td>
        </tr>

        <tr>
            <td class="textContent" style="padding-top:0px; padding-left:35px; padding-right:35px;" valign="top">
            <h1 style=" font-size:35px; margin-top:20px; line-height:50px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color:#00a99d; margin-bottom:0; font-weight:500; text-align:center;">Yay! You have a new booking request!</h1>
            &nbsp;
            </td>
        </tr>
        <tr>
            ...
            <h2 style="font-family: 'Helvetica','Arial',sans-serif;margin-bottom:20px;display:inline-block; color:#808184;  font-weight:500; text-align:center; font-size:13px; line-height:20px;"><span style="width:100%; display:block; margin-bottom:10px;">Hi {{ $view_data['host_name'] }}!</span>
            Are we excited or what?! We are happy to inform you that you have a new booking request for the following property from {{ $view_data['traveller_name'] }} for the period {{ $view_data['check_in'] }} to {{ $view_data['check_out'] }}.<br><br>
            Property: <a href="{{ $view_data['property_url'] }}" style="color:#14ace7; font-weight:500; text-decoration:none;">{{ $view_data['property_title'] }}</a>.<br>
            Amount: {{ $view_data['formatted_amount'] }}<br><br>
            We request you to respond to this booking request as soon as possible, otherwise the request will be automatically rejected within {{  $view_data['expiry_time'] }} and we would hate to see you lose the booking! 
            </h2>
            </td>
        </tr>
        ...
        <tr>
            <td class="textContent" style="padding-top:40px; padding-left:40px; padding-right:40px; text-align:center;" valign="top">
                <a href="{{ $view_data['request_url'] }}" style="text-decoration:none; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color:#fff; font-size:0.9em; padding:8px 20px; background:#7bc697; display:inline-block;line-height:15px;"> View Request</a> 
                <a href="{{ $view_data['accept_url'] }}" style="text-decoration:none; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color:#fff; font-size:0.9em; padding:8px 20px; background:#7bc697; display:inline-block;line-height:15px;"> Accept</a> 
                <a href="{{ $view_data['reject_url'] }}" style="text-decoration:none; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color:#fff; font-size:0.9em; padding:8px 20px; background:#7bc697; display:inline-block;line-height:15px;"> Reject</a> 
            </td>
        </tr>
