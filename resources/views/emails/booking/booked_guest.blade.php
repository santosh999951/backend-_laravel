...
<table border="0" cellpadding="0" cellspacing="0" style="background:#fff; margin:0 auto; max-width: 600px;">
    <tbody>
        ...
        <tr>
            ...
            Congratulations! We are pleased to inform you that your booking for the following property on <a href="{{ MAILER_SITE_URL }}">GuestHouser.com</a> has been confirmed! Time to get packing!<br/><br/>
        ...
        {{-- <tr>
            <td class="textContent" style="padding-top:40px; padding-left:40px; padding-right:40px; text-align:center;" valign="top">
                <a href="{{ $view_data['invoice_url'] }}" style="text-decoration:none; color:#fff; display:inline-block; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:0.9em; padding:8px 20px; background:#7bc697; line-height:15px;"> View Detailed Invoice </a> 
            </td>
        </tr> --}}
