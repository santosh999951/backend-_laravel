...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width"/>
    ...
    <title>Booking Cancelled Traveller</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="background:#fff; margin:0 auto; " width="600">
    <tbody>
        ...
        <tr>
            ...
            <h1 style=" font-size:35px; margin-top:20px; line-height:50px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color:#00a99d; margin-bottom:0; font-weight:500; text-align:center;">Booking cancelled successfully</h1>
            &nbsp;
            </td>
        </tr>
        <tr>
            ...
            This is to inform you that your cancellation request for the following property has been approved and we have begun the refund process.<br/><br/>Property: <a href="{{ $view_data['property_url'] }}" style="color:#14ace7; text-decoration:none;">{{ $view_data['property_title'] }}</a> <br> <br>Please note that refunds are subject to the refund policy of the host. </h2>
            </td>
        </tr>
