                                            	...
                                            	<table border="0" cellpadding="0" cellspacing="0" width="670" class="flexibleContainer">
                                                	<tr>
                                                    	<td align="center" valign="top" width="700" class="flexibleContainerCell">
                                                            ...
                                                            -->
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"  style="background:url({{STATIC_BASE_URL.'images/mailer_images/reset-password/background.png'}}); background-repeat:no-repeat; background-position:20px 55px; background-color:#f1f1f1; position:relative; ">
                                                                    

                                                                    <tr>
                                                                        <td valign="top" class="textContent" style="padding-top:30px; padding-right:30px;">
                                                                            <img src="{{STATIC_BASE_URL.'images/logo/project_mailer/logo.png'}}" style="float:right;">
                                                                        </td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td valign="top" class="textContent" style="padding-top:20px; padding-left:40px; padding-right:40px;">
<h1 style="color:#fff; font-size:45px; line-height:55px; font-family: 'Arial', sans-serif; font-weight:300; color:#00a99d;  ">
Booking not available.
</h1>

<br> <br>
<h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:500; font-size:0.955em; line-height:20px;">
Hi {{ $to_name }}, <br>
Booking request for property <a href='{{ $property_link }}'>{{ $property_title }}</a> has been automatically cancelled due to non availability.
</h2>
<br>

<a href="{{ $link }}" style=
"text-decoration:none; color:#fff; font-size:0.9em; padding:4px 10px; background:#7bc697; border-radius:3px; -moz-border-radius:3px; -webkit-border-radius:3px;">Click here to view details</a> <br><br>
...
<h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:600; font-size:1.1em; line-height:30px;"> Thank You!</h2>
                                                                            ...
                                                                            <tr>
                                                                <td valign="top" width="600"class="textContent" style="text-align:center;  background:url({{STATIC_BASE_URL.'images/mailer_images/reset-password/reset-footer.png'}}); background-repeat:no-repeat; background-size:contain; font-family: 'Raleway', sans-serif; font-weight:600; height:320px;   color:#666; margin-top:20px;">
