...
<table border="0" cellpadding="0" cellspacing="0" style="background-image:url('{{STATIC_BASE_URL}}images/project_mailers/feathers/feathers_notification/notification_bg.png'); background-repeat:no-repeat; background-color:#fff; " width="600">
	<tbody>
		...
		<tr>
			<td class="textContent" style="padding-top:10px; padding-left:0px; padding-right:0; text-align:center;" valign="top"><img alt="Selfie" src="{{STATIC_BASE_URL}}images/project_mailers/feathers/levels/level_4.png" style="display:inline-block;" /></td>
		</tr>
		<tr>
			...
			You are now a Juvenile.</h1>
			</td>
		</tr>
		<tr>
			<td class="textContent" style=" padding-top:15px; text-align:center; padding-left:0; padding-right:0;  " valign="top">
			<p style="color:#808080; font-size:14px; margin-bottom:0; line-height:18px; font-family: 'Raleway', sans-serif; font-weight:500;  text-align:center; padding-top:0; margin-top:0; padding-left:120px; padding-right:120px;">You have stepped into level 2 of Feathers. Now, you earn 2.75 times more feathers than before along with special privileges of dedicated trip assistance, preferred booking requests and flexible payment options!.</p>
			&nbsp;

			<p style="color:#808080; font-size:14px; margin-bottom:0; line-height:18px; font-family: 'Raleway', sans-serif; font-weight:500;  text-align:center; padding-top:0; margin-top:0; padding-left:95px; padding-right:95px;"><span style="font-weight:600;">Note:</span> In order to remain in this level, you will need to maintain the count of 6000 Feathers in your Feather Bank or book eight trips in a span of twelve months.</p>
			&nbsp;

			<p style="color:#00a89b; font-size:15px; display:block; margin-bottom:0; line-height:20px; font-family: 'Raleway', sans-serif; font-weight:600;  text-align:center; padding-top:0px; margin-top:0; ">You are just 14000 Feathers from leveling up!<br />
			<a href="{{ URL::to('feathers/invite') }}" style="text-decoration:none; color:#29abe2; margin-top:3px; display:inline-block;">Next level : Adult Bird </a></p>
			</td>
		</tr>
		<tr>
			<td class="textContent" style=" padding-top:0px;  padding-left:40px; padding-right:40px; padding-bottom:40px; " valign="top">
			<p style="color:#00a89b; font-size:15px; display:block; margin-bottom:0; line-height:20px; font-family: 'Raleway', sans-serif; font-weight:600;  text-align:center; padding-top:30px; margin-top:0; ">Explore The Local Way To Stay!<br />
			Team GuestHouser</p>
			</td>
		</tr>
		<tr>
			...
			<p style="display:inline-block; text-align:center; font-family: 'Raleway', sans-serif; font-weight:600; color:#666;  font-size:0.7em;  vertical-align:top;  padding-top:10px; margin-top:0;">Contact us at {{GH_CONTACT_NUMBER_DISPLAY}} (Toll Free) &copy; GuestHouser.com 2014 All rights reserved. | &nbsp;</p>
			<a href="#" style="display:inline-block;text-align:center;  margin-left:-7px;font-family: 'Raleway', sans-serif;  font-weight:600; color:#0071bc;  font-size:0.7em; vertical-align:top;  padding-top:10px;">Unsubscribe </a></td>
		</tr>
		<tr>
		</tr>
	</tbody>
