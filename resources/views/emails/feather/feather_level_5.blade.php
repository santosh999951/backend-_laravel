...
<table border="0" cellpadding="0" cellspacing="0" style="background-image:url('{{STATIC_BASE_URL}}images/project_mailers/feathers/feathers_notification/notification_bg.png'); background-repeat:no-repeat; background-color:#fff; " width="600">
	<tbody>
		...
		<tr>
			<td class="textContent" style="padding-top:10px; padding-left:0px; padding-right:0; text-align:center;" valign="top"><img alt="Selfie" src="{{STATIC_BASE_URL}}images/project_mailers/feathers/levels/level_5.png" style="display:inline-block;" /></td>
		</tr>
		<tr>
