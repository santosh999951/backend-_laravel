...
<table border="0" cellpadding="0" cellspacing="0" style="background-image:url('{{STATIC_BASE_URL}}images/project_mailers/feathers/feathers_notification/notification_bg.png'); background-repeat:no-repeat; background-color:#fff; " width="600">
	<tbody>
		...
		<tr>
			<td class="textContent" style="padding-top:10px; padding-left:0px; padding-right:0; text-align:center;" valign="top"><img alt="Selfie" src="{{STATIC_BASE_URL}}images/project_mailers/feathers/levels/level_3.png" style="display:inline-block;" /></td>
		</tr>
		<tr>
			...
			You are now a Fledgling.</h1>
			</td>
		</tr>
		<tr>
			<td class="textContent" style=" padding-top:15px; text-align:center; padding-left:0; padding-right:0;  " valign="top">
			<p style="color:#808080; font-size:14px; margin-bottom:0; line-height:18px; font-family: 'Raleway', sans-serif; font-weight:500;  text-align:center; padding-top:0; margin-top:0; padding-left:120px; padding-right:120px;">You have stepped into level 3 of Feathers. Now, you can earn twice many feathers.</p>
			&nbsp;

			<p style="color:#808080; font-size:14px; margin-bottom:0; line-height:18px; font-family: 'Raleway', sans-serif; font-weight:500;  text-align:center; padding-top:0; margin-top:0; padding-left:95px; padding-right:95px;"><span style="font-weight:600;">Note:</span> In order to remain in this level, you will need to maintain the count of 4000 Feathers in your Feather Bank or book four trips in a span of two years.</p>
			&nbsp;
			...
			<a href="{{ URL::to('feathers/invite') }}" style="text-decoration:none; color:#29abe2; margin-top:3px; display:inline-block;">Next level : Juvenile </a></p>
			</td>
		</tr>
		<tr>
