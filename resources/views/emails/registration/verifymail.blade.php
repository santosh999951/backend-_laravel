                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="670" class="flexibleContainer">
                                                    <tr>
                                                        <td align="center" valign="top" width="700" class="flexibleContainerCell">
                                                            ...
                                                            -->
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"  style="background:url({{$view_data['password_reset_bg']}}); background-repeat:no-repeat; background-position:20px 55px; background-color:#f1f1f1; position:relative; ">
                                                                    

                                                                    <tr>
                                                                        <td valign="top" class="textContent" style="padding-top:30px; padding-right:30px;">
                                                                            <img src="{{$view_data['logo']}}" style="float:right;">
                                                                        </td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td valign="top" class="textContent" style="padding-top:20px; padding-left:30px;">
                                                                            <h1 style="color:#fff; font-size:45px; line-height:55px; font-family: 'Arial', sans-serif; font-weight:300; color:#00a99d;  "> We are happy that<br>
you’re here!</h1>              <br> <br>
                                                                        <h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:500; font-size:0.955em; line-height:20px;"> Hi! {{$view_data['user_name']}}, <br><br>
Please follow the link below to verify your email address </h2>
<a href="{{ $view_data['verification_link'] }}">Click here to verify email</a>
 <br>
<h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:500; font-size:0.955em; line-height:20px;"> OR </h2><h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:500; font-size:0.955em; line-height:20px;">Enter following verification code: {{$view_data['ucode']}}</h2>
<br><br>
<h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:6c00; font-size:1.1em; line-height:30px;"> Thank You!</h2>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <tr>
                                                                <td valign="top" width="600"class="textContent" style="text-align:center;  background:url({{$view_data['mail_verify_footer']}}); background-repeat:no-repeat; background-size:cover; font-family: 'Raleway', sans-serif; font-weight:600; height:320px;   color:#666; margin-top:20px;">
