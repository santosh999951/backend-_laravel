                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="670" class="flexibleContainer">
                                                    <tr>
                                                        <td align="center" valign="top" width="700" class="flexibleContainerCell">
                                                            ...
                                                            -->
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"  style="background:url({{WEBSITE_URL.'images/mailer_images/reset-password/background.png'}}); background-repeat:no-repeat; background-position:20px 55px; background-color:#f1f1f1; position:relative; ">
                                                                    

                                                                    <tr>
                                                                        <td valign="top" class="textContent" style="padding-top:30px; padding-right:30px;">
                                                                            <img src="{{WEBSITE_URL.'images/mailer_images/reset-password/logo.png'}}" style="float:right;">
                                                                        </td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td valign="top" class="textContent" style="padding-top:20px; padding-left:40px; padding-right:40px; ">
                                                                            <h1 style="color:#fff; font-size:45px; line-height:55px; font-family: 'Arial', sans-serif; font-weight:300; color:#00a99d;  "> It’s okay! Reset your <br>
password.</h1>              <br> <br>
                                                                        <h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:500; font-size:0.955em; line-height:20px;">Hi, {{ $user_name }}<br><br>
Reset your password, complete this <a href="https://www.guesthouser.com/password/reset">Form</a> Using This code: {{ $ucode }} </h2>

<br> <br>
<h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-size:1.1em; font-weight:600; line-height:30px;"> Thank You!</h2>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <tr>
                                                                <td valign="top" width="600"class="textContent" style="text-align:center;  background-repeat:no-repeat; background-size:cover; font-family: 'Raleway', sans-serif; font-weight:600; height:320px;   color:#666; margin-top:20px; background-image:url({{WEBSITE_URL.'images/mailer_images/reset-password/reset-footer.png'}}); ">
