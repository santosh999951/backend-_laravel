                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"  style="background-image:url({{WEBSITE_URL.'images/mailer_images/reset-password/background.png'}}); background-repeat:no-repeat; background-position:20px 55px; background-color:#f1f1f1; position:relative; ">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent" style="padding-top:20px; padding-left:40px; padding-right:40px;">
                                                                            <h1 style="color:#fff; font-size:45px; line-height:55px; font-family: 'Arial', sans-serif; font-weight:300; color:#00a99d;  "> You Have Been Invited<br></h1>              <br> <br>
                                                                        <h2 style="font-family: 'Raleway', sans-serif; color:#00a99d; font-weight:500; font-size:0.955em; line-height:20px;">
Your friend <strong>{{$name}}</strong> has invited you on Guesthouser, The Local Way To Stay.<br>
</h2>

<br>
<a href="{{ $referralUrl }}" style=
"text-decoration:none; color:#fff; font-size:0.9em; padding:4px 10px; background:#7bc697; border-radius:3px; -moz-border-radius:3px; -webkit-border-radius:3px;"> Register Now</a> <br><br>
