	...
	<tbody>
		...
		<tr>
			...
			<p style="color:#00a89b; font-size:14px; margin-bottom:0; line-height:18px; font-family: 'Raleway', sans-serif; font-weight:500;  text-align:center; padding-top:0; margin-top:0; padding-left:85px; padding-right:85px;">
				Hi {{$view_data['name']}}!
				<br><br>
				We have added {{$view_data['wallet_currency']}} {{$view_data['amount']}} to your wallet for your
                review of the following accommodation: <a href="{{$view_data['property_link']}}" > {{$view_data['property_title']}} </a>
				<br>
