	...
	<tbody>
		...
		<tr>
			...
			<p style="color:#00a89b; font-size:14px; margin-bottom:0; line-height:18px; font-family: 'Raleway', sans-serif; font-weight:500;  text-align:center; padding-top:0; margin-top:0; padding-left:85px; padding-right:85px;">
				Hi {{$view_data['name']}}!
				<br><br>
                GuestHouser has added {{$view_data['wallet_currency']}} {{$view_data['amount']}} to your wallet. 
								Your current balance is {{$view_data['wallet_currency']}}  {{$view_data['wallet_balance']}} and will expire on {{$view_data['expire_on']}}.  
								What are you waiting for then? Head to the beaches of Goa or explore the mountains of Manali. 
								Stay in a quaint cottage or make a tree house your home. Go on, get travelling, and take your friend along!
				<br>
